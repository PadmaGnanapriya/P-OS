...
os_draw_background:
	...
	mov ah, 0Ah			; Draw colour section
	mov cx, 1840
	...
	mov ah, 0Ah			; Draw white bar at bottom
	mov bh, 0
	mov cx, 80
	mov bl, 00011111b
	mov al, ' '
...
.noright:
	...
	.ok_button_string	db 'Padma', 0
	.cancel_button_string	db 'Exit', 0
	.ok_button_noselect	db 'Isuru', 0
	.cancel_button_noselect	db '   ANjana   ', 0
